package justfatlard.lava_walker.integration;
...
public final class BookOfferDialogue {
	...
	private static final String OPTION_ID = "lava-walker:book";
	...
	private static final ResourceKey<Enchantment> LAVA_WALKER = ResourceKey.create(
		Registries.ENCHANTMENT, Identifier.fromNamespaceAndPath("lava-walker", "lava_walker"));
	...
	private static ItemStack enchantedBook(ServerPlayer player) {
		return player.level().registryAccess()
			...
			.flatMap(registry -> registry.get(LAVA_WALKER))
